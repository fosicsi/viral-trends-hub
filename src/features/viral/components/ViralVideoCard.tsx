...
export function ViralVideoCard({ video, onOpen, saved = false, onToggleSave, onGenerateScript, onTagClick }: ViralVideoCardProps) {
            ...
            <div className="p-4 flex flex-col flex-1 gap-3">
                ...
                <div className="mt-auto grid grid-cols-1 gap-2 pt-2">
                    ...
                    {saved && onGenerateScript && (
                        <Button
                            variant={video.scriptStatus === 'done' ? "default" : "outline"}
                            className={`w-full rounded-xl h-9 text-xs font-bold ${video.scriptStatus === 'done'
